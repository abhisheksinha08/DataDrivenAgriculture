...
crop_df <- read.csv("Modeling/Recommendation Models/Yield/Bajra_Normalized.csv")
...
write.csv(data_df, "Modeling/Recommendation Models/Final Data/bajra_final.csv", row.names = F)
