...
crop_df <- read.csv("Modeling/Recommendation Models/Yield/Maize_Normalized.csv")
...
write.csv(data_df, "Modeling/Recommendation Models/Final Data/maize_final.csv", row.names = F)
