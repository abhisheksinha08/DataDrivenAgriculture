...
crop_df <- read.csv("Modeling/Recommendation Models/Yield/Paddy_Normalized.csv")
...
#Rice(Paddy) Sowing Time is July

# Taking only July Month's weather in consideration
weather_df <- weather_df[weather_df$month==7,]

#Taking Water Depth of August Quarter
water_df <- water_df[water_df$Month == 'August',]
...
write.csv(data_df, "Modeling/Recommendation Models/Final Data/paddy_final.csv", row.names = F)
