...
depth_db$Quarter <- as.factor(depth_db$Quarter)
...
ggplotly(ggplot(data = depth_db[,], aes(x=District, y=Depth, fill=District)) + geom_boxplot() + facet_grid(Quarter~., scales = "free_y") + ylab("Quarterly Average Depth"))
```
